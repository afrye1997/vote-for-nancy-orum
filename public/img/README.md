...
named `IMG_1560`–`IMG_1565`, renamed here to what they show. Four have targets
(the easel, the log, the bridge and her with the painting); the other two —
...
| `nancy-with-her-painting.jpeg` | Home, beside the growth heading |
